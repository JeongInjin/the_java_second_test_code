package me.injin.cleancodetdd.primefactors;
...
public class PrimeFactorsTest {
    ...
    public void canFactorIntoPrimes() {
        ...
        assertPrimeFactors(2 * 2 * 3 * 3 * 5 * 7 * 7 * 11 * 13, list(2 , 2 , 3 , 3 , 5 , 7 , 7 , 11 , 13));
    }

    private void assertPrimeFactors(int n, List<Object> list) {
